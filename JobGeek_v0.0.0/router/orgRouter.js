...
router
  ...
  .post(orgCont.forgotPassword)
  .get(orgCont.forgotPasswordPage);
router
  .route("/reset_password")
  .post(orgCont.resetPassword)
  .get(orgCont.resetPasswordPage);
router
  .route("/reset_email")
  .post(auth, orgCont.resetEmail)
  .get(orgCont.resetEmailPage);
